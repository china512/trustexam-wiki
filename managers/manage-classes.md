...
!["Выбор студентов"](/select-user-class.jpg)
...
!["Импорт студентов"](/import-users.jpg)
...
!["Импортированные студенты"](/imported-users.jpg)
...
!["Список кодов приглашений"](/invite-code-list.jpg)
...
!["Создание кода"](/create-invite-code-1.jpg)

> **Скриншот: Форма создания кода приглашения (Шаг-2)**

!["Создание кода"](/create-invite-code-2.jpg)

> **Скриншот: Форма создания кода приглашения (Шаг-3)**

!["Создание кода"](/create-invite-code-3.jpg)
